...
const Label = styled.span `
  ...
  font-size: 13px;
`;
export const ReactionNode = (props) => {
    const { node } = props;
    ...
    return (_jsxs(NodeView, { className: 'node', style: {
        ...
        }, children: [_jsxs(ReactionName, { children: [_jsx(Icon, { style: { color: data?.material?.color }, children: data?.material?.icon }), _jsx(Label, { children: label })] }), subLabel &&
                _jsx(ReactionOwner, { style: { color: token.colorTextSecondary }, children: subLabel })] }));
};
