...
import { IReactionMeta, IConfigMeta, IActivityMaterial } from "@rxdrag/schema"
...
export function useGetSingleNodeConfig() {
  ...
  const getSingleNodeConfig = useCallback((nodeMeta: IReactionMeta<IConfigMeta>, material: IActivityMaterial | undefined) => {
