import { IConfigMeta, IActivityMaterial, IReactionMeta } from "@rxdrag/schema"
...
export function useGetControllerReactionConfig() {
  ...
  const getNodeConfig = useCallback((nodeMeta: IReactionMeta<IConfigMeta>, material: IActivityMaterial | undefined) => {
