...
export const calcElementOuterWidth = (innerWidth, style)=>{
    return innerWidth + parseFloat(style.marginLeft) + parseFloat(style.marginRight) + parseFloat(style.paddingLeft) + parseFloat(style.paddingRight) + parseFloat(style.borderLeftWidth) + parseFloat(style.borderRightWidth);
};
...
export const calcElementRotate = (element)=>{
    var _element_style;
    const transform = element === null || element === void 0 ? void 0 : (_element_style = element.style) === null || _element_style === void 0 ? void 0 : _element_style.transform;
    if (transform) {
        var _transform_match;
        var _transform_match_;
        return Number((_transform_match_ = (_transform_match = transform.match(/rotate\(\s*([-\d.]+)/)) === null || _transform_match === void 0 ? void 0 : _transform_match[1]) !== null && _transform_match_ !== void 0 ? _transform_match_ : 0);
    } else {
        return 0;
    }
};
export const calcElementScale = (element)=>{
    ...
    if (transform) {
        var _transform_match;
        var _transform_match_;
        return Number((_transform_match_ = (_transform_match = transform.match(/scale\(\s*([-\d.]+)/)) === null || _transform_match === void 0 ? void 0 : _transform_match[1]) !== null && _transform_match_ !== void 0 ? _transform_match_ : 0);
    } else {
        return 0;
    }
};
