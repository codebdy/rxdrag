...
export class ComponentSelector {
    ...
    ${(parentNode === null || parentNode === void 0 ? void 0 : parentNode.title) || (parentNode === null || parentNode === void 0 ? void 0 : parentNode.meta.componentName)}
    `;
        itemDiv.style.whiteSpace = "nowrap";
        itemDiv.addEventListener("click", ()=>{
            this.menuDiv.style.height = "0";
            parentNode && this.engine.getActions().selectNodes([
                parentId
            ], parentNode === null || parentNode === void 0 ? void 0 : parentNode.documentId);
        });
        this.menuDiv.appendChild(itemDiv);
        (parentNode === null || parentNode === void 0 ? void 0 : parentNode.parentId) && this.creatParentItem(parentNode.parentId);
    }
    constructor(engine){
        this.engine = engine;
        this.name = "default.component-selector";
        this.items = 0;
