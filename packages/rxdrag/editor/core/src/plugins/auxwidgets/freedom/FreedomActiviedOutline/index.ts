...
//悬停轮廓线
export class FreedomActiviedOutlineImpl implements IPlugin {
  name = "default.freedom.actived-outline";
...
export const FreedomActiviedOutline = (engine: IDesignerEngine) => {
  return new FreedomActiviedOutlineImpl(engine)
}
