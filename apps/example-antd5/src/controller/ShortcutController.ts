import { ControllerFactory, Controllers, EventFunc, EventFuncs, IController, IControllerMeta, PropListener, PropsListener, UnListener, VariableListener } from "@rxdrag/minions-runtime-react"
...
export class ShortcutController implements IController {
  ...
  constructor(public meta: IShortcutControllerMeta, protected context?: unknown) {
...
export const ShortcutControllerFactory: ControllerFactory = (meta: IControllerMeta, controllerContext: unknown) => {
  return new ShortcutController(meta, controllerContext)
}